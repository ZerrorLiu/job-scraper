...
- A manual `Not Interested` decision suppresses a matching repost for the
  following 30 days.
...
- [x] Recent matching `Not Interested` decisions suppress reposts without
      suppressing unrelated roles.
